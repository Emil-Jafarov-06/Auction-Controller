package com.project.msauction.exception.handler;


import com.project.msauction.exception.BadRequestException;
import com.project.msauction.exception.ConflictException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleNotSaved(NotSavedException ex) {
        return ResponseEntity
